...
Heed the warning. This code takes upwards of six hours to run on the Stat department's 24-core machine (dependent on number of active users). If you try to run it on your laptop, you're going to have a bad day, and that does not bode well for my grade. 
